...
using TransmorpherNPC.NPCs;
using TransmorpherNPC;
...
namespace TransmorpherNPC.UI
{
    internal class TransmorpherUI : UIState
    {
        ...
        public override void OnDeactivate()
        {
            if (!_vanillaItemSlot.Item.IsAir)
            {
                ...
                Main.LocalPlayer.QuickSpawnClonedItem((Terraria.DataStructures.IEntitySource)_vanillaItemSlot.Item, _vanillaItemSlot.Item);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Main.LocalPlayer.talkNPC == -1 || Main.npc[Main.LocalPlayer.talkNPC].type != ModContent.NPCType<Transmorpher>())
            {
                ...
                ModContent.GetInstance<TransmorpherNPC>().TransmorpherUserInterface.SetState(null);
            }
        }
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            {
                string message = "Place an item here to Transmorph";
